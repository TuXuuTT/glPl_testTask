...
/*
    ...
    public void beforeClassInit() throws MalformedURLException {
        ...
        adminUser = new User(EnvironmentConfigurator.getInstance().getLogin(), EnvironmentConfigurator.getInstance().getPassword()).setFullName("Hannah").setRole(UserRole.ADMINISTRATOR.getValue()).setLoginName(EnvironmentConfigurator.getInstance().getLogin());
